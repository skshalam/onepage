        ...
        <div className='onepage-main-body position-relative'>
            ...
            <div className="">
                <svg width="147" height="62" viewBox="0 0 147 62" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 0H147L0 62V0Z" fill={useThemeStyles?.primary_color} />
                </svg>
                    ...
                    <div className="sl-details-body-part">
                        ...
                        <a href="http://menu.myewards.in/edit_outlet_ebill/15" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                <path d="M15.4366 20.895C13.5669 21.5243 11.5458 21.5443 9.66404 20.952C7.78229 20.3597 6.13692 19.1858 4.96469 17.5991C3.79246 16.0124 3.1538 14.0947 3.14059 12.122C3.12738 10.1492 3.74032 8.22319 4.8912 6.62093C6.04209 5.01867 7.67159 3.8228 9.54524 3.20539C11.4189 2.58798 13.4401 2.58086 15.3181 3.18505C17.196 3.78925 18.8339 4.97361 19.9961 6.56773C21.1582 8.16185 21.7847 10.0835 21.7854 12.0563C21.7552 12.8125 21.6637 13.565 21.5116 14.3063" stroke={useThemeStyles.primary_color} strokeWidth="1.17188" />
                                <path d="M14.6604 19.1625C13.9897 19.9245 13.2545 20.6271 12.4629 21.2625" stroke={useThemeStyles.primary_color} strokeWidth="1.17188" />
                                <path d="M12.4629 2.625C14.9793 4.82359 16.5364 7.91894 16.8016 11.25C16.8561 11.8547 16.8674 12.4625 16.8354 13.0687" stroke={useThemeStyles.primary_color} strokeWidth="1.17188" />
                                <path d="M12.4629 2.625C11.0975 3.81505 10.0006 5.28165 9.24489 6.92762C8.48914 8.57359 8.09177 10.3614 8.0791 12.1725C8.0791 18.2475 10.8091 20.0475 12.4516 21.2625" stroke={useThemeStyles.primary_color} strokeWidth="1.17188" />
                                <path d="M4.35156 7.46252H20.6191" stroke={useThemeStyles.primary_color} strokeWidth="1.17188" />
                                <path d="M12.4629 2.62134V21.2626" stroke={useThemeStyles.primary_color} strokeWidth="1.17188" />
                                <path d="M4.60669 17.0549H14.3529" stroke={useThemeStyles.primary_color} strokeWidth="1.17188" />
                                <path d="M3.14038 12.1725L21.7854 11.9437" stroke={useThemeStyles.primary_color} strokeWidth="1.17188" />
                                <path d="M20.5515 21.3751L22.2128 19.7101L19.2128 16.7101L20.919 15.6188C20.9439 15.6041 20.9637 15.5822 20.9758 15.556C20.988 15.5298 20.9919 15.5005 20.987 15.4721C20.9821 15.4436 20.9687 15.4173 20.9485 15.3966C20.9284 15.3759 20.9024 15.3619 20.874 15.3563L15.1403 14.0138C15.1166 14.009 15.0921 14.0101 15.069 14.0171C15.0458 14.024 15.0248 14.0366 15.0077 14.0537C14.9906 14.0708 14.978 14.0918 14.971 14.115C14.9641 14.1381 14.963 14.1626 14.9678 14.1863L16.2128 20.0288C16.2188 20.0572 16.2331 20.0832 16.2539 20.1034C16.2747 20.1237 16.301 20.1373 16.3296 20.1425C16.3581 20.1477 16.3876 20.1444 16.4142 20.1328C16.4408 20.1212 16.4634 20.102 16.479 20.0776L17.5515 18.3751L20.5515 21.3751Z" stroke={useThemeStyles.primary_color} strokeWidth="1.17188" />
                            </svg>
                        </a>
