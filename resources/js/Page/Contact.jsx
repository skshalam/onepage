            ...
            <div className='socail-linkppart'>
                <div className="sl-details-body">
                    ...
                    <div className="sl-details-body-part">
                        <a href={data_contact.social_links.facebook_link} target="_blank" rel="noopener noreferrer">
                        ...
                        <a href={data_contact.social_links.instagram_link} target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                        ...
                        <a href={data_contact.social_links.twitter_link} target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                        ...
                        <a href={data_contact.social_links.linkedin_link} target="_blank" rel="noopener noreferrer">
                        ...
                        <a href={data_contact.social_links.zomato_link} target="_blank" rel="noopener noreferrer">
